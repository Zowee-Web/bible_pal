#!/bin/bash
# generate_cinematic_story.sh
# Generates ONE cinematic Bible-inspired story using Gemma 7B
# Usage: ./generate_cinematic_story.sh <mood> [story_number]
#
...
# Parse arguments
if [[ $# -lt 1 ]]; then
    echo -e "${RED}Usage: $0 <mood> [story_number]${NC}"
...
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${CYAN}  Bible PAL - Cinematic Story Generation${NC}"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
...
# CINEMATIC_PROMPT - The core template for Gemma 7B
CINEMATIC_PROMPT="You are a biblical storyteller, not a preacher.

Write ONE cinematic, Bible-inspired story for Bible PAL.
...
TONE:
• Immersive, human, and emotionally grounded
• Calm but engaging
• NEVER preachy or instructional

STORY STRUCTURE (CRITICAL):
1. Begin in the middle of a moment — no setup or explanation.
2. Follow ONE imperfect human character.
3. The character must experience doubt, hesitation, or inner conflict.
4. Allow silence, uncertainty, or waiting to create tension.
5. Do NOT explain spiritual meaning early.
6. Let the story unfold naturally through action and reflection.
7. Use sensory detail (wind, footsteps, firelight, silence, distance).
8. Avoid modern language, slang, or contemporary references.
9. Do NOT quote Bible verses directly.
10. Spiritual meaning should emerge subtly near the end.
11. End with resonance, not instruction.

BIBLICAL CONTEXT:
• Inspired by the world, tone, and themes of Scripture
• Faith-aligned and reverent
• God's presence should feel subtle (timing, stillness, inner knowing)
• The story should feel like it could belong alongside biblical narratives

IMPORTANT AVOID:
• No moral summaries
• No \"this teaches us\" language
• No sermon-style explanations
• No repeated encouragement phrases
• Avoid overusing the word \"faith\"
...
while [[ $attempt -le $MAX_ATTEMPTS ]]; do
    ...
    while [[ $segment -le $MAX_SEGMENTS ]] && [[ $word_count -lt $MIN_WORDS ]]; do
        ...
        if [[ $segment -eq 1 ]]; then
            # First segment: use full CINEMATIC_PROMPT
...
echo ""
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}✓ Cinematic Story Generation Complete!${NC}"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
if [[ -n "${audio_file:-}" && -f "$audio_file" ]]; then
    ...
    echo -e "Audio File:   ${YELLOW}(none)${NC}"
fi
