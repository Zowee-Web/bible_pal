...
3. **The open door** — a rotated tail from the Open-Door Tail Family (adult; see the section below) / *"…or, what's on your mind?"* (kid, fixed).
   **Required.** It signals the third response path (redirect) to a first-time user who would otherwise hear only yes/no. Without it the beat fails Voice Audit Q7. It also keeps the offer an invitation, never an obligation. *(2026-07-15: the adult tail was a single fixed line — "or, tell me what's on your heart today" — through the first two shipped slates; it became a rotated, flavor-matched family because a fixed tail is the beat's most repetition-exposed element on the 100th hearing.)*
...
## The Open-Door Tail Family (2026-07-15)

The adult open-door tail is a **rotated, flavor-matched family**, not a fixed line — the same design language as the Accept Acknowledgment below (*"softly flavor-matched… the user won't consciously notice; it just makes Journey Mode feel handcrafted rather than random"*). Adam's ratifying insight: tie the tail loosely to the mood of the journey, so PAL subconsciously reads as having chosen its words carefully — without the user ever spotting the pattern.

**Mechanics.** The tail is a separate clip stitched after the beat body (the body ends at the invitation's question mark). Each play draws from the journey's flavor bucket **plus the neutral pool**, never repeating the immediately-previous tail. The flavor lives on the journey manifest (`offerTailFlavor: hopeful | heavier | gentle`) — a one-word curator retune. The kid tail is unchanged and fixed (*"or, what's on your mind?"* — Kid-Lane Appendix governs).

**The pool (Adam-ratified 2026-07-15):**

- **Hopeful** *(rise, deliverance, praise)* — *"Or, tell me what's on your heart today."* (the original anchor) · *"Or, tell me what's on your mind."*
- **Heavier** *(lament, the fall, grief)* — *"Or, tell me what's been weighing on you."* · *"Or, tell me what today has been like for you."*
- **Gentle** *(trust, quiet, provision)* — *"Or, tell me how you're doing today."* · *"Or, tell me whatever's on your mind."*
- **Neutral** *(every rotation)* — *"Or, tell me what's been on your mind lately."* · *"Or, tell me what you've been thinking about."* · *"Or, tell me how your day is going."* · *"Or, tell me what brought you here today."*

**Register guards.** Every tail is still the same job — the third-path invitation — in PAL's own voice: warm and everyday is welcome; filler small-talk ("what's up," "how's it going so far") is not. Rejected at ratification: *"where you are today"* (too abstract), *"what you're carrying today"* (presumes a burden — the heavier bucket's *"weighing on you"* earns it instead). Tails must never contain instant-accept tokens (yes/yeah/yep) and end on soft sounds for the v3 clip-guard.

**Ledger note.** `outgoing_beats.json` beatText is the **body only** (ends at the question mark) as of this amendment; the completion invariant locks the body wording. Tails are shared clips (`tail_<slug>`), not per-beat text.
...
- **2026-07-15** (Open-Door Tail Family, Adam-ratified) — the adult tail became a rotated, flavor-matched family of 10 lines (2 hopeful / 2 heavier / 2 gentle / 4 neutral), stitched as a separate clip after the beat body; `offerTailFlavor` tag on journey manifests; ledger beatText migrated to body-only; kid tail unchanged. Rationale + register guards in the new section above. All 46 adult offer bodies re-rendered; prior full-tail clips archived per never-delete.
