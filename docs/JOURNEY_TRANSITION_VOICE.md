...
3. **Esther — the decree → the throne room** · *solemn; darker next chapter* *(trimmed at promotion)*
   > *Last time, we stood with Esther as she learned what had been decreed against her people… Esther is about to decide whether to speak, when speaking could cost her everything… or, tell me what's on your heart today.*
...
6. **Psalm 23 — green places → the valley** · *no single human figure; God as the relational center* *(trimmed at promotion; valley phrasing corrected at verification)*
   > *Last time, we walked the green places beside the Shepherd, near the water that does not rush… the Shepherd is about to lead us through the valley of the shadow of death — and stay just as close… or, tell me what's on your heart today.*
   The exemplar of the ratified who-may-be-the-"who" rule: the Shepherd is the passage's own center, and *"us"* puts the listener inside the psalm. (Verification note: an earlier trim read *"the darkest valley"* — the signature NIV/NRSV rendering, a banned-translation fingerprint. Corrected to the public-domain phrase. Kept in this annotation as a live warning: paraphrase drifts toward the translations you've heard most.)
