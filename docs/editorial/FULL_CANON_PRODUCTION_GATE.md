...
> **Status:** Approved planning gate (pending Adam's sign-off), 2026-07-16
...
| # | Story | Reference | Source | Coverage | Lane | Priority | Difficulty | Wave | Must precede beats |
|---|-------|-----------|--------|----------|------|----------|-----------|------|--------------------|
| 01 | The Fall | Genesis 3:1-24 | net new essential | absent both lanes | both | high | very heavy | Wave 1 | — |
| 02 | Cain and Abel | Genesis 4:1-16 | net new essential | absent both lanes | adult | high | heavy | Wave 1 | — |
| 03 | Peter's Denial and the Rooster | Luke 22:54-62 / John 18:15-27 | net new essential | absent both lanes | both | high | heavy | Wave 1 | yes |
| 04 | Peter's Confession at Caesarea Philippi | Matthew 16:13-20 | salvaged division verification | absent both lanes | both | high | standard | Wave 1 | yes |
| 05 | John 1 Prologue — The Word Became Flesh | John 1:1-18 | net new essential | absent both lanes | both | high | standard | Wave 1 | — |
| 06 | David Spares Saul at En-gedi | 1 Samuel 24 | salvaged division verification | absent both lanes | both | high | standard | Wave 1 | — |
| 07 | The Bronze Serpent | Numbers 21:4-9 | salvaged division verification | absent both lanes | both | medium | heavy | Wave 1 | — |
| 08 | Jesus Before Pilate — 'What Is Truth?' | John 18:28-19:16 / Luke 23:1-25 | net new essential | absent both lanes | adult | high | heavy | Wave 4 | yes |
| 09 | Barabbas and the Crowd's Choice | Matthew 27:15-26 / Mark 15:6-15 | net new essential | absent both lanes | adult | high | heavy | Wave 4 | yes |
| 10 | Joseph's Dream — the Angel Appears to Joseph | Matthew 1:18-25 | net new essential | absent both lanes | both | medium | standard | Wave 1 | — |
| 11 | Rehoboam — the Kingdom Splits | 1 Kings 12 | net new essential | absent both lanes | adult | medium | standard | Wave 4 | — |
| 12 | The Flight to Egypt & Herod's Massacre | Matthew 2:13-18 | net new essential | adult missing partial coverage | adult | medium | heavy | Wave 4 | — |
| 13 | The Rich Man and Lazarus | Luke 16:19-31 | net new essential | absent both lanes | adult | medium | heavy | Wave 4 | — |
| 14 | The Rich Fool | Luke 12:13-21 | net new essential | adult missing partial coverage | adult | medium | standard | Wave 5 | — |
| 15 | The Ten Virgins | Matthew 25:1-13 | net new essential | absent both lanes | both | medium | standard | Wave 5 | — |
| 16 | The Sheep and the Goats | Matthew 25:31-46 | net new essential | absent both lanes | both | medium | standard | Wave 5 | — |
| 17 | The Sower | Mark 4:1-9 / Matthew 13:1-23 | adult parity | adult missing kid exists | adult | high | standard | Wave 3 | — |
| 18 | The Persistent Widow | Luke 18:1-8 | adult parity | adult missing kid exists | adult | medium | standard | Wave 3 | — |
| 19 | Joseph in Egypt — Potiphar's House & Prison | Genesis 39-40 | adult parity | adult missing kid exists | adult | medium | heavy | Wave 3 | yes |
| 20 | The Workers in the Vineyard | Matthew 20:1-16 | net new essential | absent both lanes | both | low | standard | Wave 5 | — |
| 21 | The Weeds (Tares) Among the Wheat | Matthew 13:24-30, 36-43 | net new essential | absent both lanes | both | low | standard | Wave 5 | — |
| 22 | The Pearl of Great Price | Matthew 13:45-46 | net new essential | absent both lanes | both | low | standard | Wave 5 | — |
...
```
Call (1175)  →  Water (1124)  →  Confession [NEW]  →  Denial [NEW]  →  Restoration (1130, exists)
```
...
| 'Give Us a King' | 1 Samuel 8 | **LOW IMMEDIATE VALUE** — Verified absent, important-supporting, but not conspicuous to an ordinary user and no journey pressure. Near-term-eligible, not gating. |
...
|---|-------|-----------|-----------------|------|
| G1 | Passover & the Plagues | Exodus 7-12 | Moses (moses_arc_1) | Adult lane — kid 1907 already exists. HEAVY (death of the firstborn). |
| G2 | Jacob & Esau Reconcile | Genesis 33 | Jacob (jacob_full_arc) | Pairs with G9. STANDARD. |
| G3 | Bathsheba & Uriah | 2 Samuel 11 | David (david_arc_7) | Pairs with G7. VERY HEAVY (adultery/murder) — adult only. |
| G4 | Delilah & Samson's Capture | Judges 16:4-22 | Samson (samson_arc) | HEAVY (betrayal/blinding) — adult; kid subtraction very hard. |
| G5 | The Gibeonite Covenant | Joshua 9 | Joshua (joshua_conquest_arc) | Pairs with G6. STANDARD. |
| G6 | Achan's Judgment & the Capture of Ai | Joshua 7:16-8:29 | Joshua (joshua_conquest_arc) | HEAVY (divine judgment). Resolves the 1294 cliffhanger. |
| G7 | Absalom's Death — 'O my son' | 2 Samuel 18 | David (david_rebellion_arc) | Terminal grief beat. HEAVY. Pairs with G3. |

**Strongly consider — G8-G10**

| G | Story | Reference | Character / arc | Note |
|---|-------|-----------|-----------------|------|
| G8 | Moses Flees to Midian | Exodus 2:11-25 | Moses (moses_arc_1) | Opening seam of the Deliverance arc. |
| G9 | The Stolen Blessing | Genesis 27 | Jacob (jacob_full_arc) | Origin of the Jacob-Esau conflict. Pairs with G2. |
| G10 | The Flood | Genesis 7-8 | Noah (noah_arc) | Also the primeval-arc turning point (connects to Fall/Cain above). |

**Defer until arc approached — G11-G16**

| G | Story | Reference | Character / arc | Note |
|---|-------|-----------|-----------------|------|
| G11 | Korah's Rebellion | Numbers 16 | Moses back-half | Until the Moses wilderness back-half arc is approached. |
...
1. **The Sower** (Mark 4:1-9 / Matt 13) — kid 1912 exists; the flagship parable, adult lane empty.
2. **The Persistent Widow** (Luke 18:1-8) — kid 1905 exists; adult 1539 is the adjacent parable, not this one.
3. **Joseph in Egypt / Potiphar's House** (Gen 39-40) — kid 1906 bundles it; fills the Joseph adult-arc middle (coat 1037 → reveal 1003).
...
### Wave 4 — Heavy adult-only & Passion
...
### Wave 5 (optional) — Teaching & parable completion
...
### Enrichment adjunct — Contemplative, low-risk
*Batch size:* anytime

Isaiah 9 (Advent) · Psalm 1

Non-narrative; route separately from the story batches.
