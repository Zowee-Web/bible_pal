...
class VerseService {
  ...
  static const List<VerseResponse> _joyfulVerses = [
    VerseResponse(
      ...
      context: 'Your joy is a gift. This psalm reminds us that every day is crafted by God\'s hand, worthy of celebration.',
    ),
    VerseResponse(
      reference: 'Philippians 4:4',
      text: 'Rejoice in the Lord always! Again I will say, "Rejoice!"',
      context: 'Paul encourages us to find joy not in circumstances, but in the constant presence of the Lord.',
    ),
    VerseResponse(
      ...
      context: 'Gratitude is more than a feeling—it\'s a practice that draws us closer to God\'s heart.',
    ),
  ];
  ...
  static const List<VerseResponse> _wearyVerses = [
    VerseResponse(
      ...
      context: 'Jesus offers an invitation to those who are exhausted. Rest is not weakness—it\'s a sacred trust in God\'s provision.',
    ),
    VerseResponse(
      ...
      context: 'The Good Shepherd knows when we need rest. He doesn\'t drive us relentlessly but leads us to places of renewal.',
    ),
    VerseResponse(
      reference: 'Isaiah 40:28-31',
      text: 'He gives power to the weak. He increases the strength of him who has no might. Even the youths faint and get weary, and the young men utterly fall; but those who wait for Yahweh will renew their strength.',
      context: 'When our own strength fails, God\'s strength becomes available. Waiting on Him is not passive—it\'s a posture of trust.',
    ),
  ];
  ...
  static const List<VerseResponse> _anxiousVerses = [
    VerseResponse(
      ...
      context: 'Anxiety loses its power when we bring it into God\'s presence. His peace is not just absence of trouble, but a presence that guards our hearts.',
    ),
    VerseResponse(
      reference: 'Matthew 6:25-34',
      text: 'Therefore I tell you, don\'t be anxious for your life... See the birds of the sky, that they don\'t sow, neither do they reap, nor gather into barns. Your heavenly Father feeds them. Aren\'t you of much more value than they?',
      context: 'Jesus reminds us that the God who cares for sparrows cares infinitely more for you. Worry cannot add a single hour to your life, but trust can change how you live each hour.',
    ),
    VerseResponse(
      ...
      context: 'God doesn\'t say the threatening circumstances will disappear, but that He will be present in them with you.',
    ),
  ];
  ...
  static const List<VerseResponse> _hurtingVerses = [
    VerseResponse(
      ...
      context: 'God doesn\'t stand at a distance from our pain. He draws close, especially when our hearts are breaking.',
    ),
    VerseResponse(
      reference: '2 Corinthians 1:3-4',
      text: 'Blessed be the God and Father of our Lord Jesus Christ, the Father of mercies and God of all comfort, who comforts us in all our affliction, that we may be able to comfort those who are in any affliction.',
      context: 'The comfort God gives us in our pain is never meant to end with us. It becomes a gift we can share with others who hurt.',
    ),
    VerseResponse(
      ...
      context: 'This doesn\'t mean all things are good, but that God is at work even in painful circumstances, weaving them into something redemptive.',
    ),
    VerseResponse(
      reference: 'Psalm 147:3',
      text: 'He heals the broken in heart, and binds up their wounds.',
      context: 'Healing is God\'s nature. He is the gentle physician who tends to our deepest wounds with care and patience.',
    ),
  ];
  ...
  static const List<VerseResponse> _neutralVerses = [
    VerseResponse(
      ...
      context: 'Faith is learning to trust God\'s wisdom even when the path ahead isn\'t clear to us.',
    ),
    VerseResponse(
      reference: 'Hebrews 11:1',
      text: 'Now faith is assurance of things hoped for, proof of things not seen.',
      context: 'Faith is not blind optimism, but a confident trust in God\'s character and promises, even when we can\'t see the outcome.',
    ),
    VerseResponse(
      ...
      context: 'Trials are not punishments but opportunities for faith to grow stronger, like a muscle strengthened through use.',
    ),
  ];
}
...
class VerseResponse {
  ...
  final String translation; // Bible translation label (e.g., 'WEB', 'KJV', 'ASV')
